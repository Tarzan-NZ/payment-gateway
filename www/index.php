...
if (isset($_POST['add-to-cart'])) {
	...
	// Convert the result from the database into an associative array
	...
	for($i = 0; $i<count($_SESSION['cart']); $i++ ) {
		...
		// Is the item ID of the product they are adding the same 
		// as the ID of this cart item ?
		if ( $_SESSION['cart'][$i]['id'] == $productID ) {
			$found = true;

			// Yes, thay have already added this item to their cart
			// Update the quantity
...
include 'app/templates/products-list.php';
